class script(object):
    START_TXT = """<b>ʏᴏ.. ʏᴏ.. {}🙋,
ɪ'ᴍ <a href='https://t.me/PikachuMovie_Robot'>♡︎ 𝘗𝑖𝑘ꪖᥴꫝꪊ ♡︎</a>, ʏᴏᴜ ᴄᴀɴ ᴜsᴇ ᴍᴇ ᴀs ᴀᴜᴛᴏ-ғɪʟᴛᴇʀ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ ....
...
<b>NOTE:</b>
1. 𝘗𝑖𝑘ꪖᥴꫝꪊ should have admin privillage.
...
2. 𝘗𝑖𝑘ꪖᥴꫝꪊ supports buttons with any telegram media type.
...
<b>NOTE:</b>
these are the extra features of 𝘗𝑖𝑘ꪖᥴꫝꪊ 
